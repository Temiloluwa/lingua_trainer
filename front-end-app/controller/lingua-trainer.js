...
class Trainer {
    constructor(temperature = 0.5, chatStarter, verbose = false) {
        ...
        Object.defineProperty(this, "chatPrompt", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
    ...
    initializeChat({ systemMessage = "", humanMessage = "", initialPrompt = "" }, memory, verbose = false) {
    ...
    async chatWithTutor(input, chain) {
        if (chain === null) {
...
//# sourceMappingURL=lingua-trainer.js.map